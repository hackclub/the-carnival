...
export default function AdminUsersClient({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-card border border-border rounded-[var(--radius-2xl)] overflow-hidden">
      ...
      {activeLedgerUserId ? (
        <div className="rounded-[var(--radius-2xl)] border border-border bg-card p-5 space-y-4">
