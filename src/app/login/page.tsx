...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-carnival-dark relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-lg bg-carnival-card/90 backdrop-blur rounded-3xl p-10 card-glow border border-white/10">
